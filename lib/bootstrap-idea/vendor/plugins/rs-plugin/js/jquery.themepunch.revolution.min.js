...
(function (e, t) {
  ...
  function r(r, i) {
    ...
    if (!r.hasClass("revslider-initialised")) {
      ...
      e(window).resize(windowResizeListener);
      try {
  ...
  e.fn.extend({
    destroyRevolution: function() {
      window.removeEventListener('focus', windowFocusListener);
      e(window).unbind('resize', windowResizeListener);
      punchgs.TweenLite.ticker.fps(0);
    },
    revolution: function (n) {
      punchgs.TweenLite.ticker.fps(undefined);
      defaults = {
        delay: 9e3,
        startheight: 500,
        startwidth: 960,
  ...
  var windowFocusListener = function (e) {
    setTimeout(function () {
  ...
  var o = function (n, r) {
    ...
    if (i && !s) {
      ...
      if (window.addEventListener) {
        window.addEventListener("focus", windowFocusListener, false);
