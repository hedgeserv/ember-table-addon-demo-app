...
module.exports = {
  ...
  treeForPublic: function () {
    ...
    var owlDir = this.app.bowerDirectory + '/owl-carousel/owl-carousel';
    var owlTree = new Funnel(owlDir, {
      srcDir: '/',
      include: ['grabbing.png'],
      destDir: '/assets'
    });
    ...
    return mergeTrees([rsImageTree, owlTree, fontAwesome, fontello, images]);
  },
