...
Demo app for our fork of Addepar's <code>ember-table-addon</code>. [![Build Status](https://travis-ci.org/hedgeserv/ember-table-addon-demo-app.svg?branch=master)](https://travis-ci.org/hedgeserv/ember-table-addon-demo-app)
